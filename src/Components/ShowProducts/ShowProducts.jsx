      ...
      <div className="container">
        <div className="page-wrapper-content">
          ...
          >
            <div className="sidebar-container">
              <div className="close_Sidebar">
                <div className="container  d-flex justify-content-between align-items-center py-3 bg-black text-white">
          ...
          <div className="content w-100">
            <div className="filter py-3 border-bottom border-top" id="side">
